void main() {
  ...
  print(greetSomeone("Adán S. Galván"));
  ...
  print(greetSomeoneTyped("Luz Adreana"));
  ...
  print(greetSomeoneHourOfDay("Adrio", 23));
  ...
  print(greetSomeoneHourOfDay("Adán", null));
  ...
  print(infoCarListStatus(buyerName: "Amelí"));
